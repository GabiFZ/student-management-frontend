...
const Assignments = () => {
    ...
    const handleEdit = (assignment) => {
        ...
        setForm({
            ...
            deadline: formatDeadlineInput(assignment.deadline),
    ...
    const handleDelete = async (id) => {
        if (globalThis.confirm("Ești sigur că vrei să ștergi această temă?")) {
            try {
    ...
    return (
        <div style={{ width: "100%", margin: "0 auto" }}>
            ...
            <div style={{
                ...
                <div>
                    ...
                    <p style={{ fontSize: "13px", color: "#8aaa85", margin: "4px 0 0" }}>
                        {assignments.length} teme înregistrate
                    </p>
                </div>
                <button
                    ...
                    onClick={() => {
                        setEditingAssignment(null);
                        setForm({ ...emptyForm, maxScore: 100 });
                        setErrorMessage("");
                        setShowModal(true);
                    }}>
                            ...
                            filtered.map((assignment, index) => (
                                ...
                                >
                                    ...
                                    <td style={{ padding: "14px 18px" }}>
                                        <span style={styles.badge("#e8f5e3", "#2d7a27")}>
                                            {assignment.maxScore ?? "-"}
                                        </span>
                                    </td>
                                    <td style={{ padding: "14px 18px", fontSize: "13px", color: "#4a6645", overflow: "hidden" }}>
            ...
            <div style={{
                ...
                Afișare {filtered.length} din {assignments.length} teme
            </div>
